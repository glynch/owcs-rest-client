...
public class DefaultTypeResources implements TypeResources {
    ...
    public AssetTypeBean read() throws RestClientException {
        return restClient.get(restClient.getBaseUrl() + TYPE_URI_TEMPLATE , AssetTypeBean.class, type);
    }
    ...
    public AssetTypeBean create(AssetTypeBean assetTypeBean) throws RestClientException {
        ...
        return restClient.put(restClient.getBaseUrl() + TYPE_URI_TEMPLATE, assetTypeBean, AssetTypeBean.class, type);
    }

    @Override
    public AssetTypesBean subtypes() throws RestClientException {
        return restClient.get(restClient.getBaseUrl() + TYPE_SUBTYPES_URI_TEMPLATE, AssetTypesBean.class, type);
    }

    @Override
    public AssetTypeBean subtype(String subtype) {
        Assert.hasText(subtype, "subtype cannot be null or empty");
        return restClient.get(restClient.getBaseUrl() + TYPE_SUBTYPES_SUBTYPE_URI_TEMPLATE, AssetTypeBean.class, type, subtype);
    }
}
